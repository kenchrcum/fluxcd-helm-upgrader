...
class Config:
    ...
    DEFAULT_HEADERS = {
        "User-Agent": "fluxcd-helm-upgrader/0.6.4 (+https://github.com/kenchrcum/fluxcd-helm-upgrader)",
...
def main() -> None:
    ...
    if run_mode == "once":
        logging.info("🚀 Starting FluxCD Helm upgrader v0.6.4 (single-run mode)")
    else:
        logging.info("🚀 Starting FluxCD Helm upgrader v0.6.4 (continuous mode, interval: %ss)", interval)
